...
const resetCodeSchema = new mongoose_1.Schema({
    user: {
...
const ResetCode = mongoose_1.models.ResetCode ||
    (0, mongoose_1.model)("ResetCode", resetCodeSchema);
exports.default = ResetCode;
